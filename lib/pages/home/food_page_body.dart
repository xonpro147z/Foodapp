...
class _FoodPageBodyState extends State<FoodPageBody> {
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: SmallText(text: "Thích hợp",color: Colors.black26,),
              ),
              SizedBox(width: Dimensions.height30,),
              //líst food and iamges
    ])
    ),
        SizedBox(height: 25),
                   ...
                   child: Container(
                     ...
                     child: Row(
                       children: [
                         ...
                         Expanded(
                           child: Container(
                             height: Dimensions.listViewTextContSize, //cao
                             decoration: BoxDecoration(
                             ...
                             child: Padding(
                               ...
                               child: Column(
                                 ...
                                 children: [
                                   ...
                                   SmallText(text: "Vẫn là cafe nhưng món này đặc biệt "),
                                   SizedBox(height: Dimensions.heigth10,),
                                   Row(
  ...
  Widget _buildPageItem(int index, ProductModel popularProduct){
    ...
    if(index== _currenPageValue.floor()){
      ...
      var currScale = _scaleFactor+ (_currenPageValue-index+1)*(1- _scaleFactor);
      var currTrans = _height*(1-currScale)/2;
      ...
      children: [
        ...
        Align(
          ...
          child: Container(
            ...
            child: Container(
                padding: EdgeInsets.only(top: Dimensions.heigth15,left: 15,right: 15),
